...
// include the library developer.h to embed the content of it
#include "developer.h"
...
//declare a structure to define and store the group logo, the name and the aliases of the developers
...
//function to print the developers and the group logo
